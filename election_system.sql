...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 06, 2025 at 01:13 PM
...
INSERT INTO `candidates` (`candidate_id`, `user_id`, `status`, `election_id`, `party`, `manifesto`) VALUES(19, 55, 'rejected', NULL, 'bimpi', 'druto nirbachon');
INSERT INTO `candidates` (`candidate_id`, `user_id`, `status`, `election_id`, `party`, `manifesto`) VALUES(20, 54, 'approved', 2, 'amlig', 'druto fire asbo');
...
INSERT INTO `elections` (`election_id`, `title`, `description`, `start_time`, `end_time`, `status`) VALUES(2, 'chairman election', 'bllllllahh blahhh', '2025-10-05 00:00:00', '2025-10-06 00:00:00', 'upcoming');
...
INSERT INTO `users` (`user_id`, `name`, `email`, `password_hash`, `nid`, `created_at`, `is_admin`) VALUES(1, 'tanha', 'tanha@gmail.com', '$2y$10$pqGCyunge5tqDLs8yhsXbu80xM1JQ9Yu06tDTf04mzqlfR0GBbbF2', '0987654321234', '2025-09-28 13:53:01', 1);
INSERT INTO `users` (`user_id`, `name`, `email`, `password_hash`, `nid`, `created_at`, `is_admin`) VALUES(54, 'opu', 'opu@gmail.com', '$2y$10$n5ZR/9oe8cxPubJpgeCkqe6bdYJZuOhDGJIhTKdpn/4x2ukd7WloW', '2222222222222', '2025-10-06 09:58:05', 0);
INSERT INTO `users` (`user_id`, `name`, `email`, `password_hash`, `nid`, `created_at`, `is_admin`) VALUES(55, 'aniya', 'aniya@gmail.com', '$2y$10$0SjyUOf9xbx60bU/UK93.eddHt9OYiFg0GPuXFpz5qeSPWRruoSiu', '3333333333333', '2025-10-06 09:58:33', 0);
INSERT INTO `users` (`user_id`, `name`, `email`, `password_hash`, `nid`, `created_at`, `is_admin`) VALUES(56, 'tahmid', 'tahmid@gmail.com', '$2y$10$XBeez23ZN5j55nXKHOvW..0oUpah5ycQHbfczt8m3HjkNhgjhaK3y', '7777777777777', '2025-10-06 10:49:31', 0);
...
INSERT INTO `voters` (`voter_id`, `user_id`, `nid_photo_path`, `self_photo_path`, `face_data_path`, `is_verified`) VALUES(37, 54, 'uploads/voters/nid_54_Screenshot 2025-09-02 172510.png', 'uploads/voters/self_54_Screenshot 2025-09-02 172517.png', NULL, 1);
INSERT INTO `voters` (`voter_id`, `user_id`, `nid_photo_path`, `self_photo_path`, `face_data_path`, `is_verified`) VALUES(38, 55, 'uploads/voters/nid_55_Screenshot 2025-09-02 172556.png', 'uploads/voters/self_55_Screenshot 2025-09-03 125322.png', NULL, 1);
